...
class UserDAO:
    ...
    def validate_login(self, username, password):
        ...
        try:
            ...
            print "\nNow going to get user from self.users.find({_id:username}) from blog users :"
            print "self is :", self, ":"
    ...
    def add_user(self, username, password, email):
        ...
        try:
            ...
            print "\nInserting self.users.insert_one(user) :\n", user, ":\n"
            self.users.insert_one(user)
            print "\n After self.users.insert_one(user) : Check db.users.find() in blog :\n"
